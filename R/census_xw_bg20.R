#' Weighted crosswalk for 2010 & 2020 Census Block Group values in 2020 Block Group boundaries
#'
#' This crosswalk provides 2020 Block Group level data on Housing Units and Population in 2020 census Block Group 
#' geographies for easy cross-comparison.
#' 
#' @format A tibble with 5,116 rows and 9 variables:
#' \describe{
#'   \item{bg20_id}{dbl 2010 Census Block Group FIPS Code}
